...
public class LoggerConstants {
    ...
    public static final String NEW_CHAT_MESSAGE_CREATED_AND_SEND_TO_MESSAGE_SERVICE_TOPIC_NAME_MESSAGE_SENDER_IDENTITY_TEMPLATE =
            KAFKA_MESSAGING + "New chat message created and send to Message service (Kafka topic: %s, Message sender identity %s)";
    ...
    public static final String RETRIEVE_ONLINE_FRIENDS_FROM_MESSAGE_SERVICE_TEMPLATE =
            "Retrieve online friends from Message service (Profile identity: %s)";
