...
import static com.social.profile.config.ConfigConstants.KAFKA_TOPIC_FOR_NEW_REGISTERED_USERS_CREATED_TEMPLATE;
...
public class RegisteredUserTopic {
    ...
    public NewTopic registeredUserTopicForAuthenticationService() {
        NewTopic registeredUserTopicForProfileService = TopicBuilder
                ...
                .build();
        log.info(String.format(KAFKA_TOPIC_FOR_NEW_REGISTERED_USERS_CREATED_TEMPLATE, topicName));
