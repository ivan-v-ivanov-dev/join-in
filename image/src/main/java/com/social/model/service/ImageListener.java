...
import static com.social.model.service.constants.LoggerConstants.NEW_USER_MESSAGE_RECEIVED_FROM_AUTHENTICATION_SERVICE_TEMPLATE;
...
public class ImageListener {
    ...
    public ImageListener(ImageService imageService,
                         @Value("${spring.kafka.topic.name.registered.user}") String newUserTopic) {
